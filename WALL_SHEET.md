...
- **Built-up area speed limit**
  Memory cue: town = 50
  Test answer: 50 km/h unless signs say otherwise.
- **Rural local road speed limit**
  Memory cue: local rural = 60 now
  Test answer: 60 km/h on many rural local roads.
- **Regional road speed limit**
  Memory cue: regional = 80
  Test answer: 80 km/h unless signs say otherwise.
- **National road speed limit**
  Memory cue: national = 100
  Test answer: 100 km/h unless signs say otherwise.
- **Motorway speed limit**
  Memory cue: motorway = 120
  Test answer: 120 km/h unless signs say otherwise.
- **Posted limit rule**
...
- **Steady amber light**
  Memory cue: amber = stop if safe
  Test answer: Stop unless it is unsafe to do so.
...
- **Continuous white centre line**
  Memory cue: solid = stay left
  Test answer: Keep left and do not cross it except for access or an emergency.
- **Broken yellow side line**
  Memory cue: hard shoulder
  Test answer: It marks a hard shoulder.
- **Single yellow line**
  Memory cue: no parking at certain times
  Test answer: No parking during the times shown.
- **Double yellow lines**
...
- **Regulatory sign shape**
  Memory cue: rule sign = circle
  Test answer: Circular.
- **Motorway sign colour**
  Memory cue: motorway = blue
  Test answer: Blue.
- **National road sign colour**
  Memory cue: national = green
  Test answer: Green.
